...
abstract class Bf_BillingEntity extends \ArrayObject {
    ...
    */
	...
	protected static function retireAndGrabFirst($endpoint, $payload, array $queryParams = array(), $customClient = NULL, $responseEntity = NULL) {
		$client = is_null($customClient) ? static::getSingletonClient() : $customClient;
	...
	protected static function retireAndGrabCollection($endpoint, $payload, array $queryParams = array(), $customClient = NULL, $responseEntity = NULL) {
		$client = is_null($customClient) ? static::getSingletonClient() : $customClient;
