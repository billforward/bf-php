...
class Bf_Notification extends Bf_MutableEntity {
	 ...
	 * @param string (Default: NULL) ID of specific webhook for which you wish to GET notifications.
	 * @return Bf_Notification[]
	 */
	public static function getForTimeRange($timeStart, $timeEnd = NULL, $webhookID = NULL, $options = NULL, $customClient = NULL) {
		if (is_null($timeEnd)) {
			$timeEnd = time();
		}
