...
spl_autoload_register(function($className) {
    ...
    if (!isset($classMap)) {
        ...
        $classMap = array(
            ...
            'Bf_CouponWrapperResponse' => $baseDir . '/BFPHPClient/Entities/Coupon/backend/CouponWrapperResponse.php',
            ...
            'Bf_Payment' => $baseDir . '/BFPHPClient/Entities/Payment/Payment.php',
            'Bf_PaymentMethod' => $baseDir . '/BFPHPClient/Entities/Payment/PaymentMethod.php',
            ...
            'Bf_PricingComponentValueAndIDRequest' => $baseDir . '/BFPHPClient/Entities/SyncRequests/PricingComponentValueAndIDRequest.php',
            ...
            'Bf_PricingComponentValueRequest' => $baseDir . '/BFPHPClient/Entities/SyncRequests/PricingComponentValueRequest.php',
            'Bf_PricingComponentValueResponse' => $baseDir . '/BFPHPClient/Entities/SyncResponses/PricingComponentValueResponse.php',
            'Bf_PricingComponentValuesRequest' => $baseDir . '/BFPHPClient/Entities/SyncRequests/PricingComponentValuesRequest.php',
            'Bf_PricingComponentValuesResponse' => $baseDir . '/BFPHPClient/Entities/SyncResponses/PricingComponentValuesResponse.php',
            ...
            'Bf_Quote' => $baseDir . '/BFPHPClient/Entities/Product/Quote.php',
            'Bf_QuoteRequest' => $baseDir . '/BFPHPClient/Entities/SyncRequests/QuoteRequest.php',
            'Bf_QuoteRequestValue' => $baseDir . '/BFPHPClient/Entities/Product/QuoteRequestValue.php',
