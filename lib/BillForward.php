...
spl_autoload_register(function($className) {
    ...
    if (!isset($classMap)) {
        ...
        $classMap = array(
            ...
            'Bf_CancellationAmendment' => $baseDir . '/BFPHPClient/Amendments/CancellationAmendment.php',
            ...
            'Bf_IssueInvoiceAmendment' => $baseDir . '/BFPHPClient/Amendments/IssueInvoiceAmendment.php',
            ...
            'Bf_TaxLine' => $baseDir . '/BFPHPClient/TaxLine.php',
